...
const testimonials = [
  ...
  {
    quote: "I've worked with Abhishek for over a decade. He treats every project like his own home. He works incredibly hard and is just a genuinely good person.",
    author: "Co-Founder",
        ...
        >
           <div>
             <div className="flex items-center gap-3 mb-2">
               ...
               <span className="text-brand-red font-sans text-xs uppercase tracking-wide font-medium">Testimonials</span>
             </div>
